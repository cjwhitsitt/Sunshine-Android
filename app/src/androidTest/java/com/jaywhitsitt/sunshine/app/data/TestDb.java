 ...
 */
package com.jaywhitsitt.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        assertTrue("Error: Couldn't validate location database row", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: unable to validate current record", cursor, values);
    ...
    public void testWeatherTable() {
        ...
        long locationRowId;
        locationRowId = testLocationTable();
        ...
        // Move the cursor to a valid database row
        assertTrue("Error: Couldn't validate weather database row", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Couldn't validate weather cursor", cursor, values);
